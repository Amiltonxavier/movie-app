...
class SeriesServices {
  ...
  async discover(filters: DiscoverTVFilters): Promise<IPaginationResponse<ITVShow>> {
    try {
      ...
      if (filters.screened_theatrically !== undefined) params.screened_theatrically = filters.screened_theatrically;
      ...
      if (filters.without_watch_providers) params.without_watch_providers = filters.without_watch_providers;
